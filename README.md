...
---
[ライセンス](https://github.com/yuta-komura/ida/blob/main/LICENSE)
...
```bash
sh ida/main/get_realtime_data.sh
```
**execute.sh**：  
メインスクリプト用  
```bash
sh ida/main/execute.sh 
```
---  
### main process  
<a href="https://imgur.com/DcRhG7R"><img src="https://i.imgur.com/DcRhG7R.png" title="source: imgur.com" /></a>
